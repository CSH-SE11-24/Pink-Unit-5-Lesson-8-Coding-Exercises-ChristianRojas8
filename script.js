...
let allCapsButton = document.getElementById("allCapsButton")
console.log(allCapsButton)
let textToChange = document.getElementById("textToChange")
console.log(textToChange)
allCapsButton.addEventListener("click", function(event) {
  textToChange.textContent = textToChange.textContent.toUpperCase()
})
